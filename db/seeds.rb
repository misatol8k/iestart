...
# require "csv"
# CSV.foreach('db/iestart_specialists.csv', headers: true) do |row|
#     Specialist.create(
#     name: row[1],
#     expertise_property:"得意な物件です", 
#     consultation_item:"得意な相談項目です", 
#     qualification:row[16], 
#     description:row[17], 
#     career:row[18], 
#     newly_built_house:row[4], 
#     used_house:row[5] , 
#     newly_built_condominium:row[6] , 
#     used_condominium:row[7] , 
#     land:row[8] , 
#     price_and_pepayment:row[9] , 
#     building_and_structure:row[10]  , 
#     floor_plan:row[11]  , 
#     surrounding_environment:row[12]  , 
#     family_relatives:row[13] , 
#     other_point:row[14] 
#   )
# end
...
Customer.create(name: "kokyaku1", mail: "kokyaku1@mail.com", specialist_id: 1)
Customer.create(name: "kokyaku2", mail: "kokyaku2@mail.com", specialist_id: 2)
...
Property.create(property_type: 1, url: "url/bukkenjouhou1.jp", other: "sonota1", trader: "XXhome", price: 30000, newly_built_house:1 , used_house:0 , newly_built_condominium:0 , used_condominium:0 , land:0 , price_and_pepayment:1 , building_and_structure:0 , floor_plan:1 , surrounding_environment:0 , family_relatives:1, other_point:0, customer_id:3 )